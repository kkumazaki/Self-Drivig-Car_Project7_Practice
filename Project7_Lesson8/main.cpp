...
int main() {
  ...
  std::ofstream outputfile3("test_predict.txt");
  ...
  for (int i = 0; i < X_test.size(); ++i) {
    ...
    outputfile3 << predicted << std::endl;
  }
  outputfile3.close();  
  ...
  cout << "You got " << (100*fraction_correct) << " correct" << endl;
    ...
    std::ofstream outputfile("debug\\result.txt");
    outputfile<< "You got " << (100*fraction_correct) << " correct" << endl;
    outputfile.close();
